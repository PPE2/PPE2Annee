...
INSERT INTO secteur (libellesecteur) VALUES
	('Aix'),
	('Batz'),
	('Belle-Ile-en-Mer'),
	('Bréhat'),
...
INSERT INTO liaison (distmiles, portdepart, portarrivee, idsecteur) VALUES
	...
	('8', 'Quiberon', 'Sauzon', (SELECT idsecteur FROM secteur WHERE libellesecteur = 'Belle-Ile-en-Mer')),
	('7.9', 'Sauzon', 'Quiberon', (SELECT idsecteur FROM secteur WHERE libellesecteur = 'Belle-Ile-en-Mer')),
	('23.7', 'Vannes', 'Le Palais', (SELECT idsecteur FROM secteur WHERE libellesecteur = 'Belle-Ile-en-Mer')),
	('25.1', 'Le Palais', 'Vannes', (SELECT idsecteur FROM secteur WHERE libellesecteur = 'Belle-Ile-en-Mer')),
	('8.8', 'Quiberon', 'Port St Gildas', (SELECT idsecteur FROM secteur WHERE libellesecteur = 'Houat')),
	('8.8', 'Port St Gildas', 'Quiberon', (SELECT idsecteur FROM secteur WHERE libellesecteur = 'Houat')),
	('7.7', 'Lorient', 'Port-Tudy', (SELECT idsecteur FROM secteur WHERE libellesecteur = 'Ile de Groix')),
	('7.4', 'Port-Tudy', 'Lorient', (SELECT idsecteur FROM secteur WHERE libellesecteur = 'Ile de Groix'));
...
INSERT INTO traversee( heuretraversee, datetraversee, idliaison, nombateau) VALUES
	...
	( '07:00', '2015-11-13', '83', 'Al'' xi'),
	( '08:00', '2015-11-13', '84', 'Kor'' Ant'),
	( '09:00', '2015-11-13', '85', 'Luce isle'),
	( '10:00', '2015-11-13', '86', 'Kor'' Ant'),
	( '11:00', '2015-11-13', '87', 'Ar Solen'),
	( '12:00', '2015-11-13', '88', 'Al'' xi'),
	( '13:00', '2015-11-13', '89', 'Kor'' Ant'),
	( '14:00', '2015-11-13', '90', 'Luce isle');
